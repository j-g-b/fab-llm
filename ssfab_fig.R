...
barplot(c(mean(apwrd5n1[1, ]), mean(apwrd5n1[2, ]), apwrd5n1[3, ]),
        ...
        ylim = c(0, 1), ylab = "Avg. Power", col = c('black', "#08519c", "#cbc9e2", "#9e9ac8", "#756bb1"), border = NA)
abline(h = 1, col = '#a50f15', lty = 2)
